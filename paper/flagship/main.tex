...
\%% Tail sections of the flagship, drafted separately to avoid editing main.tex
%% concurrently with the evidence-sections agent. Merge into main.tex replacing the
%% matching TODO stubs.
