...
| **Git** | `main`, tags `v1.0.0` → `v1.32.0`. **`v1.32.0` is the newest tag and it IS pushed** — it peels to `54bbb40` on origin (`git ls-remote --tags origin`, re-probed 2026-09-02), and its GitHub Release is dated 2026-08-28T21:14:29Z. v1.31.0 points at `1444b8a`, Release 2026-08-28T20:01:30Z; v1.30.0 points at `5298b99` (2026-08-28T08:06:04Z); v1.29.0 points at `2b183ba`. A `v*` tag push triggers the tokenless OIDC release workflow | github.com/ChanMeng666/archlang |
