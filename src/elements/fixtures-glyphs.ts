...
export function fixtureGlyph(
  ...
  switch (category) {
    ...
    case "toilet": {
      ...
      const cisH = r.h * 0.22;
      poly([{ x: r.x, y: r.y }, { x: r.x + r.w, y: r.y }, { x: r.x + r.w, y: r.y + cisH }, { x: r.x, y: r.y + cisH }], body);
    ...
    case "lavatory": {
      ...
      poly([{ x: r.x, y: r.y }, { x: r.x + r.w, y: r.y }, { x: r.x + r.w, y: r.y + r.h }, { x: r.x, y: r.y + r.h }], body);
    ...
    case "shower": {
      ...
      poly([{ x: r.x, y: r.y }, { x: r.x + r.w, y: r.y }, { x: r.x + r.w, y: r.y + r.h }, { x: r.x, y: r.y + r.h }], basin);
    ...
    case "bath": {
      ...
      poly(roundedRect({ x: r.x + inset, y: r.y + inset, w: r.w - 2 * inset, h: r.h - 2 * inset }, Math.min(r.w, r.h) * 0.12), basin);
      // Tap at the left end.
    ...
    case "sink": {
      ...
      poly([{ x: r.x + m, y: by }, { x: r.x + m + bw, y: by }, { x: r.x + m + bw, y: by + bh }, { x: r.x + m, y: by + bh }], basin);
      poly([{ x: r.x + 2 * m + bw, y: by }, { x: r.x + 2 * m + 2 * bw, y: by }, { x: r.x + 2 * m + 2 * bw, y: by + bh }, { x: r.x + 2 * m + bw, y: by + bh }], basin);
