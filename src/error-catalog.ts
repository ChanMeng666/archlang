...
export const ERROR_CATALOG: Readonly<Record<string, CatalogEntry>> = Object.freeze({
  ...
  E_FURN_ROOM: E("E_FURN_ROOM", "Furniture placed `in` an unknown room.",
  ...
  E_FURN_ROTATE: E("E_FURN_ROTATE", "Furniture rotation must be a quarter-turn.",
  ...
  E_FURN_AGAINST: E("E_FURN_AGAINST", "Invalid `against wall` fixture placement.",
  ...
  E_OPENING_WIDTH: E("E_OPENING_WIDTH", "Opening must have a positive width.",
  ...
  W_OPENING_OFF_WALL: W("W_OPENING_OFF_WALL", "Opening does not lie on any wall.",
  ...
  W_ROOM_UNREACHABLE: W("W_ROOM_UNREACHABLE", "Room cannot be reached from the entrance.",
  ...
  W_FURNITURE_OVERLAP: W("W_FURNITURE_OVERLAP", "Two pieces of furniture overlap.",
  ...
  W_FIXTURE_FLOATING: W("W_FIXTURE_FLOATING", "A plumbing/kitchen fixture is not against a wall.",
  ...
  W_FURN_CLEARANCE: W("W_FURN_CLEARANCE", "A fixture's use-space is blocked.",
  ...
  W_FIXTURE_WRONG_ROOM: W("W_FIXTURE_WRONG_ROOM", "Fixture sits outside its declared room.",
