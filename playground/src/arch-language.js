...
const ATTR = new Set(["units", "grid", "scale", "north", "material", "angle", "at", "size", "width", "thickness", "label", "hinge", "swing", "offset", "text", "close", "id", "project", "drawn_by", "date", "from", "as"]);
const ENUM = new Set(["up", "down", "left", "right", "in", "out", "mm", "true", "false"]);
