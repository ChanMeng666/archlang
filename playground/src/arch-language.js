...
const CONTROL = new Set(["plan", "component", "let", "theme", "title", "style", "import", "for", "if", "while", "else", "set", "strip", "axes"]);
const ELEMENT = new Set(["wall", "room", "door", "window", "opening", "furniture", "dim", "column"]);
const ATTR = new Set(["units", "grid", "scale", "north", "dims", "accTitle", "accDescr", "material", "angle", "at", "size", "width", "thickness", "label", "hinge", "swing", "offset", "text", "close", "id", "project", "drawn_by", "date", "from", "as", "right-of", "left-of", "below", "above", "align", "gap", "uses", "rotate", "against", "segment", "side", "on", "into", "near", "anchor", "inset", "flush", "height", "faces", "clear"]);
